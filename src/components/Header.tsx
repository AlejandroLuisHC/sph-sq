        ...
        <div className="flex items-center h-14 sm:h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-md text-gray-300 hover:text-yellow-400 hover:bg-gray-800 transition-colors duration-200"
            ...
            <div className="px-3 py-2 border-b border-gray-700">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    className={`px-3 py-1.5 rounded text-sm font-semibold transition-all duration-300 border-2 ${
                      i18n.language === "es"
                        ? "bg-yellow-400 text-gray-900 border-yellow-400"
                        : "bg-transparent text-yellow-400 border-yellow-400 hover:bg-yellow-400 hover:text-gray-900"
                    }`}
