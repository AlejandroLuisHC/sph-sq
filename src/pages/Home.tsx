      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-5 md:px-8">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mt-8 sm:mt-12">
            <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-yellow-400">
            ...
            <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-yellow-400 sm:col-span-2 lg:col-span-1">
              <h3 className="text-yellow-400 text-lg sm:text-xl font-bold mb-2 sm:mb-3">
